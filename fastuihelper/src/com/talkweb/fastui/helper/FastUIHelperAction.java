...
/**
 * FastUI V1.5版本JOSN格式转换基类
 * 
 * @author: 2013-05-31 黄勇
 */
public class FastUIHelperAction  {

    private static final Logger logger = LoggerFactory.getLogger(FastUIHelperAction.class);
    ...
    public Map initformAttribute(String attributeName,Object data){
     ...
     * */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public List<Map> initSelectData(List list,RuleSelect select) throws RuntimeException{
        if(select!=null)
        {
     ...
     * **/      
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public Map addPrefix(Object o,String prefixName){
        Map attributeMap = new HashMap();
     ...
     * */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public List<Map> initNavigationData(List list,RuleNavigation navigation){
        if(navigation!=null)
        {
            HashMap hm = new HashMap();
     ...
     * */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public Map formatDatagirdData(List list, Pagination pagination) {
        Map m = new HashMap();
        m.put("data", list);
     ...
     * */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public List<Map> initTreeData(List list,String[] attributes){
        if(attributes!=null)
        {
            HashMap hm = new HashMap();
     ...
     * */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public List<Map> initTreeData(List list,RuleTree wtree){
        if(wtree!=null)
        {
            HashMap hm = new HashMap();
            if(wtree.getId()!=null)
     ...
     * **/
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public List<Map> setAttributeValue(List list,Map m) {
        List<Map> l = null;
        if(list!=null){
            l = new ArrayList<Map>();
     ...
     * @param o
     */
    public Object excludeNullProperties(Object o) {
        try {
     ...
     * */
    private void setFieldValueByName(Object o,String fieldName,Object val) {  
        try {  
            String firstLetter = fieldName.substring(0, 1).toUpperCase();  
     ...
     *            信息内容
     */
    public Map setWarnMessage(String msg) {
        return setMessage(MessageType.Warn, msg);
    }

    public Map setWarnMessage(Throwable t) {
     ...
     *            信息内容
     */
    public Map setOkMessage(String msg) {
     ...
     * @param msg
     */
    public Map setInfoMessage(String msg) {
     ...
     *            信息内容
     * **/
    public Map setErrorMessage(String msg) {
        return setMessage(MessageType.Error, msg);
    }
    
    public Map setErrorMessage(Throwable t)
    {
        return setErrorMessage(t.getMessage());
    }
    
    public Map setErrorMessage(String msg, Throwable t)
    {
     ...
     * @param msg
     */
    public Map setSystemMessage(String msg) {
     ...
     * @param t
     */
    public Map setSystemMessage(Throwable t) {
     ...
     * @param t
     */
    public Map setSystemMessage(String msg,Throwable t) {
     ...
     *            信息内容
     */
    public Map setTimeoutMessage(String msg) {
    ...
    public Map setMessage(MessageType messageType, String msg) {
     ...
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map setMessage(MessageType messageType, String msg,String detailmsg) {
        Map m = new HashMap();
